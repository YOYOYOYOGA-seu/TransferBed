...
#define SDIO_CMD_CLK RCC_APB2Periph_GPIOD

#define SDIO_CLK_PIN GPIO_Pin_12
#define SDIO_CLK_PORT GPIOC
#define SDIO_CLK_CLK RCC_APB2Periph_GPIOC

#define SDIO_D0_PIN GPIO_Pin_8
#define SDIO_D0_PORT GPIOC
#define SDIO_D0_CLK RCC_APB2Periph_GPIOC

#define SDIO_D1_PIN GPIO_Pin_8
#define SDIO_D1_PORT GPIOC
#define SDIO_D1_CLK RCC_APB2Periph_GPIOC

#define SDIO_D2_PIN GPIO_Pin_8
#define SDIO_D2_PORT GPIOC
#define SDIO_D2_CLK RCC_APB2Periph_GPIOC

#define SDIO_D3_PIN GPIO_Pin_8
#define SDIO_D3_PORT GPIOC
#define SDIO_D3_CLK RCC_APB2Periph_GPIOC
//-----------------------------------------------------
